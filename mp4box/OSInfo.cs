                                        ...
                                        case 2: // winserver 2003
                                            {
                                                if ((osVersionInfo.wSuiteMask & VER_SUITE_DATACENTER) == VER_SUITE_DATACENTER)
                                                    ...
                                                    osName = "Windows Server 2003 标准版";
                                                break;
                                            }
                                    }
                                    break;
                                                    ...
                                                    case 1: // Vista
                                                        {
                                                                                ...
                                                                                out edition))
                                                            {
                                                                switch (edition)
                                                                {
                                                                    ...
                                                                    case PRODUCT_HOME_BASIC_N: osName = "Windows Vista 家庭普通版"; break;
                                                                    case PRODUCT_HOME_PREMIUM: osName = "Windows Vista 家庭高级版"; break;
                                                                    case PRODUCT_ENTERPRISE: osName = "Windows Vista 企业版"; break;
                                                                    case PRODUCT_BUSINESS:
                                                                    case PRODUCT_BUSINESS_N: osName = "Windows Vista 商用版"; break;
                                                                    case PRODUCT_STARTER: osName = "Windows Vista 简易版"; break;
                                        ...
                                        case 1: // Se7en
                                            {
                                                                    ...
                                                                    out edition))
                                                {
                                                    switch (edition)
                                                    {
                                                        ...
                                                        case PRODUCT_HOME_BASIC:
                                                        case PRODUCT_HOME_BASIC_N: osName = "Windows 7 家庭普通版"; break;
                                                        case PRODUCT_HOME_PREMIUM: osName = "Windows 7 家庭高级版"; break;
                                                        case PRODUCT_ENTERPRISE: osName = "Windows 7 企业版"; break;
                                                        case PRODUCT_BUSINESS:
                                                        case PRODUCT_BUSINESS_N: osName = "Windows 7 专业版"; break;
                                                        case PRODUCT_STARTER: osName = "Windows 7 入门版"; break;
                                        ...
                                        case 2: // Windows 8
                                            {
                                                                    ...
                                                                    out edition))
                                                {
                                                    switch (edition)
                                                    {
                                                        ...
                                                        case PRODUCT_CORE_N: osName = "Windows 8 核心版"; break;
                                        ...
                                        case 3: // Windows 8.1
                                            {
                                                                    ...
                                                                    out edition))
                                                {
                                                    switch (edition)
                                                    {
                                                        case PRODUCT_CORE:
                                                        case PRODUCT_CORE_COUNTRYSPECIFIC:
                                                        case PRODUCT_CORE_N: osName = "Windows 8.1 核心版"; break;
                                                        case PRODUCT_ENTERPRISE:
                                                    ...
                                                    case 1: // X
                                                        {
                                                                                ...
                                                                                out edition))
                                                            {
                                                                switch (edition)
                                                                {
                                                                    case PRODUCT_CORE:
                                                                    case PRODUCT_CORE_COUNTRYSPECIFIC:
                                                                    case PRODUCT_CORE_N: osName = "Windows 10 家庭版"; break;
                                                                    case PRODUCT_ENTERPRISE:
                                                                    case PRODUCT_ENTERPRISE_N: osName = "Windows 10 企业版"; break;
                                                                    case PRODUCT_PROFESSIONAL:
                                                                    case PRODUCT_PROFESSIONAL_N: osName = "Windows 10 专业版"; break;
                                                                    case PRODUCT_EDUCATION:
                                                                    case PRODUCT_EDUCATION_N: osName = "Windows 10 教育版"; break;
                                                                    case PRODUCT_MOBILE_CORE:
                                                                    case PRODUCT_MOBILE_ENTERPRISE: osName = "Windows 10 移动版"; break;
